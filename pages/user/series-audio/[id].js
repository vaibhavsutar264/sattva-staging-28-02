...
import SeriesVideo from "../../../components/user/audioseries/SeriesAudio";
  ...
  //}
    return (
            ...
            <div className='sec sec-style secSeriesInner'>
              <div className='container'>
                <div className='class-block mt-0'>
                  <div className='row'>
                    <div class="col-md-6 col"><h4>{title}</h4></div>
        ...
        <div className="row">
            ...
            return(
                <div
                className='col-sm-12 col-lg-4 col-md-4 seriesVideoSingle seriesAudio'
              >
                ...
                <div className='card card-view'>
                  ...
                  <div className='card-content p-3'>
                    ...
                    <div className='media-content'>
                     <audio controls className="myAudio" id='courseVidUrl'>
                        <source  className='ifmplayer'
                                              id='courseVidUrl'/>
                      </audio>
...
export const getServerSideProps= async (context) =>{
    const res = await fetch(apiRoute(`get-series-audio/${context.params.id}`));
