...
$(document).on("click", "#nav-link li", function () {
  $("#sidebar").removeClass("navmbl");
});
...
$(document).on("mouseenter", ".playerView", function () {
  $(".info").toggleClass("up");
});
...
let audio = new Audio(
  "http://music.dawnfoxes.com/_fxs_/_upls_/_sngs_/UK/clean_bandit-symphony-ft-zara_larsson.mp3"
);
